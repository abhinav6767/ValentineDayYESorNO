    ...
    return (
        <div className="max-w-7xl relative z-10 mx-auto py-20 md:py-40 px-4 w-full  left-0 top-0">
            <h1 className="text-2xl md:text-7xl font-bold text-neutral-900 dark:text-white">
                The Ultimate <br /> Valentine Studio
            </h1>
            <p className="max-w-2xl text-base md:text-xl mt-8 text-neutral-600 dark:text-neutral-200">
                ...
                Choose from our premium collection of templates for Valentine&apos;s Day,
                anniversaries, birthdays, and special achievements.
            </p>
            <div className="mt-8 flex gap-4">
                <Button size="lg" className="bg-gradient-to-r from-pink-500 to-violet-600 hover:from-pink-600 hover:to-violet-700 text-white rounded-full px-8 py-6 text-lg" asChild>
